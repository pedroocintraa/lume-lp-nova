...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-lume-500 text-white hover:bg-lume-800 shadow-lg",
        destructive:
          "bg-red-500 text-white hover:bg-red-600",
        outline:
          "border border-lume-200 bg-white hover:bg-lume-50 hover:text-lume-900",
        secondary:
          "bg-lume-100 text-lume-800 hover:bg-lume-200",
        ghost: "hover:bg-lume-50 hover:text-lume-900",
        link: "text-lume-500 underline-offset-4 hover:underline",
      },
      size: {
        default: "h-11 px-6 py-2",
        sm: "h-9 rounded-md px-3",
        lg: "h-12 md:h-14 rounded-full px-8 md:px-10 text-base md:text-lg",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
